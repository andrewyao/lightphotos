...
- [ ] Task 3: Standalone check of `segmentation.rs` against a handful of real portrait/subject photos, confirming the mask roughly matches the subject outline (requires Task 1) (files: src/segmentation.rs)
